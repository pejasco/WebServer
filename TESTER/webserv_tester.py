...
def simple_test():
	...
	# print("======================================\n")
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/birthday.py?day=6&month=4', None)
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/meme.py', None)
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/env.py', None)
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/webserv.sh', None)
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/say_hello.py', {'name': 'username'})
	# individual_test(test_cgi_request, 'http://localhost:3501', 25, '/cgi-bin/mood.py', {'mood': "%F0%9F%98%8A"})
	...
	# individual_test(test_error_code, 'http://localhost:3501', 20, '/cgi-bin/color.py', 404, "get")
	# individual_test(test_error_code, 'http://localhost:3501', 20, '/cgi-bin/hello.php', 405, "get")
