...
def simple_test():
	...
	individual_test(test_error_code, 'http://localhost:3501', 7, '/cgi-bin/color.py', 404, "get")
	individual_test(test_error_code, 'http://localhost:3501', 7, '/cgi-bin/hello.php', 405, "get")
	...
	concurrent_test(test_cgi_request, 200, 'http://localhost:3501', 25, '/cgi-bin/meme.py', None)
	concurrent_test(test_cgi_request, 200, 'http://localhost:3501', 25, '/cgi-bin/say_hello.py', {'name': 'username'})
